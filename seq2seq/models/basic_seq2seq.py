...
class BasicSeq2Seq(Seq2SeqModel):
    ...
    def __init__(self, params, mode, name="basic_seq2seq"):
        ...
        # locate: Locate an object by name importing as necessary.
    ...
    def default_params():
        ...
        params.update({
            ...
            # InitialStateBridge
            # This state is created by passing the encoder outputs
    ...
    def _create_bridge(self, encoder_outputs, decoder_state_size):
        ...
        return bridge_class(
            ...
            # encoder_outputs: A namedtuple
            decoder_state_size=decoder_state_size,
            # decoder_state_size: An integer or tuple of integers
