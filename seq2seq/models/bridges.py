...
class ZeroBridge(Bridge):
    ...
    def _create(self):
        '''returns a Tensor of shape [batch size, decoder state_size]
        or a tuple of Tensor if decoder state_size is a tuple'''
...
class InitialStateBridge(Bridge):
    ...
    Args:
      encoder_outputs: A namedtuple that corresponds to the encoder outputs.
      decoder_state_size: An integer or tuple of integers defining the
        state size of the decoder.
